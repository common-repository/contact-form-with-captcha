...
Contact form with captcha is a simple but elegant plugin that allows you to use a Google reCAPTCHA contact form on your blog.
...
3. Go to the `Contact Form With Captcha` Admin section and enter your reCAPTCHA private/secret and public/site keys and recipient email address ( and any optional parameters )
...
You can get them from the Google reCAPTCHA website(https://www.google.com/recaptcha/admin/create "Google reCAPTCHA website").
